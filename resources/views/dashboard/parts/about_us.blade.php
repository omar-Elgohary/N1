                ...
                <div class="table-responsive text-center">
                    <table class="table table-centered table-nowrap mb-0">
                        <thead class="table-light">
                            <tr>
                                <th>#</th>
                                <th>المعلومات بالعربية</th>
                                <th>المعلومات بالانجليزية</th>
                                <th>ادارة</th>
                            </tr>
                        </thead>
                        ...
                        @forelse ($infos as $key => $info)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td>{{ $info->paragraph_ar }}</td>
                                <td>{{ $info->paragraph_en }}</td>
                                <td>
        ...
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="paragraph_ar" id="paragraph" class="form-control text-end" rows="10">{{ $info->paragraph_ar }}</textarea>
                </div>

                <div class="form-group mb-3">
                    <label>معلومات الموقع بالانجليزية</label>
                    <textarea name="paragraph_en" id="paragraph" class="form-control text-end" rows="10">{{ $info->paragraph_en }}</textarea>
                </div>
...
<div class="modal fade" id="deleteInfo{{ $info->id }}" tabindex="-1" aria-labelledby="deleteInfoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                <form action="{{ route('aboutUs.destroy', $info->id) }}" method="post">
                    @csrf
                    @method('DELETE')
        ...
        <div class="modal-content modal-content-demo">
            ...
            <h5 class="modal-title">اضافة معلومة</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label>معلومات الموقع بالعربية</label>
                        <textarea name="paragraph_ar" id="paragraph" class="form-control text-end" rows="5"></textarea>
                    </div>
