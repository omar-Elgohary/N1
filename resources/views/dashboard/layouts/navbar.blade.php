...
<div class="navbar-brand-box">
    <a href="index.html" class="logo logo-dark">
        <span class="logo-sm">
            <img src="{{asset('Admin3/assets/images/newlogo.png')}}" alt="" height="22">
        </span>
        <span class="logo-lg">
            <img src="{{asset('Admin3/assets/images/newlogo.png')}}" alt="" height="20">
        </span>
    </a>
...
<div class="dropdown d-inline-block">
    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <img class="rounded-circle header-profile-user" src="{{ asset('Admin3/assets/images/users/avatar-1.jpg') }}"
            alt="Header Avatar">
