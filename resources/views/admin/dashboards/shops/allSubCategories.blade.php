...
<section class="container col-lg-12">
    <div class="col-12 d-flex flex-row-reverse p-0">
        ...
        <div class="col-6 text-start">
            <a href="#createShopSubCategory{{$category->id}}" id="coupon" class="btn btn-block btn-bordered px-4 btns" data-bs-toggle="modal">اضافة فئة فرعية</a>
            <a href="{{ route('shopCategories') }}" id="package" class="btn btn-block btn-bordered px-4 btns">جميع الأقسام</a>
        </div>
    </div> <!-- col-12 -->
