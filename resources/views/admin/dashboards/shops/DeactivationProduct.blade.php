...
<section>
    <div class="container mt-2" dir="rtl">
        ...
        <form action="#" method="post">
            ...
            <div class="col-lg-4 mt-3">
                <div class="form-group my-4">
                    <label>الحالة</label>
                    <label class="text-secondary fw-bold -bold mx-5">غير منشور</label>
                </div> <!-- 1 -->
        ...
        <div class="col-4 d-grid mx-auto mt-5">
            <a id="login" href="productDetails" class="btn mb-3">نشر المنتج</a>
            <a href="editShopProduct" id="coupon" class="btn px-5">تعديل</a>
        </div>
    </div> <!-- container -->
</section>
