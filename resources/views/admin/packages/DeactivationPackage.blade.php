...
<section>
    <div class="container" dir="rtl">
        ...
        <div class="col-4 d-grid mx-auto mt-5">
            <a id="login" href="packageDetails" class="btn mb-3">تفعيل</a>
            <a href="#DeletePackage" id="coupon" class="btn" data-bs-toggle="modal">حذف</a>
        </div>
    </div> <!-- container -->
</section>
...
{{-- DeletePackage --}}
<div class="modal fade border-0" id="DeletePackage" aria-hidden="true" aria-labelledby="DeletePackageLabel" tabindex="-1" dir="rtl">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-around">
                ...
                <a id="package" href="#" class="btn btn-block px-5 text-white">حذف</a>
            </div>
        </div> <!-- modal-content -->
    </div> <!-- modal-dialog -->
</div> <!-- modal fade -->
