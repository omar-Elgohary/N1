...
<section>
    <div class="container" dir="rtl">
        <div class="section-title text-end">
            ...
            <div class="col-lg-4 mt-3">
                <div class="form-group my-4">
                    ...
                    <label class="text-danger mx-5">غير مغعل</label>
                </div> <!-- 1 -->
        ...
        <div class="col-4 d-grid mx-auto mt-5">
            <a id="login" href="editCoupon" class="btn mb-3">تفعيل</a>
            <a href="#DeleteCoupon" id="coupon" class="btn" data-bs-toggle="modal">حذف</a>
        </div>
    </div> <!-- container -->
</section>
...
{{-- delete-coupon --}}
<div class="modal fade border-0" id="DeleteCoupon" aria-hidden="true" aria-labelledby="DeleteCouponLabel" tabindex="-1" dir="rtl">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="btn-x modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
